        ...
        function openTab(text,url,icon) {
            ...
            if($('#tabs').tabs('exists',text)){
                ...
                $("#tabs").tabs('add',{
                    ...
                    iconCls:icon,    //显示图标
                    content:"<iframe frameborder=0 scrolling='auto' style='width:100%;height:100%' src='${blog}/static/admin/"+url+"'></iframe>"
                    //url 远程加载所打开的url
                })
            }
        }
...
<body class="easyui-layout">
    ...
    <div region="west" style="width:200px;" title="导航菜单" split="true">
        <div class="easyui-accordion" data-options="fit:true,border:false">
            ...
            <div title="博客类别管理" data-options="iconCls:'icon-item'" style="padding:10px">
            ...
            <div title="评论管理" data-options="iconCls:'icon-item'" style="padding:10px">
                <a href="javascript:openTab('评论审核','commentReview.jsp','icon-review')" class="easyui-linkbutton"
                   data-options="plain:true,iconCls:'icon-review'" style="width: 150px">评论审核</a>
