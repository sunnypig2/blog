...
<body style="margin: 10px; font-family: microsoft yahei">
    <div id="p" class="easyui-panel" style="padding:10px;" title="编写博客">
        <table cellspacing="20px">
            ...
            <tr>
                ...
                <td><script id="editor" type="text/plain" style="width:95%;height:200px;"></script></td>
            </tr>
            <tr>
                <td>关键字：</td>
            ...
            <tr>
                <td></td>
                <td><a href="javascript:submitData()" class="easyui-linkbutton" data-options="iconCls:'icon-add'">发布博客</a></td>
            </tr>
        </table>
    </div>
